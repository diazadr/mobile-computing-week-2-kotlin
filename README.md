...
### **ListView**
Projek ini mengimplementasikan list view, dengan listOf, mutableListOf, pengimplementasian array adapter, setonitemclicklistener untuk toast, dan setOnItemLongClickListener untuk remove list
